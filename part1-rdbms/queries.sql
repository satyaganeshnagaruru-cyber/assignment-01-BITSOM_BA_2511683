...
SELECT c.customer_name, c.customer_city, sum(p.unit_price * o.quantity) AS total_order_value
FROM customers c
...
FROM sales_rep s 
JOIN orders o on o.sales_rep_id = s.sales_rep_id
GROUP BY s.sales_rep_name;


-- Q4: Find all orders where the total value exceeds 10,000, sorted by value descending

SELECT o.order_id,c.customer_name, (p.unit_price * o.quantity) AS total_order_value
FROM orders o
